...
?>
	...
	?>		
		<script>
			var reassetID = '<?php echo $reassetID; ?>';
	...
	<TR CLASS="bkg" id="<?php echo 'a'.$ID; ?>" 
	
	<?php if($_REQUEST['assetID'] == $ID){ ?>
		style="font-weight:bold;"
	<?php }else{ ?> style="font-weight:normal;"<?php }?>
	>
		<td style="width:420px;" ><span class="assetrow"><A HREF="#" onClick="setAsset('<?php echo 'a'.$ID; ?>');"><img src="<?php echo $imgext; ?>" border=0></A><?php echo $db->row("filename"); ?></SPAN></td>
<?php		
		//print '<tr CLASS="bkg">';
