...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  <TR>
    <TD ROWSPAN="2" VALIGN="TOP"><IMG SRC="images/edit_lesson.gif" ALIGN="absmiddle"> &nbsp;</TD>
...
<param name="menuItems" value="
      {Properties,edit_lesson_bottom.php?ID=<?php echo $ID;?>,edit_main,_}
      {Lesson Topics,edit_lesson_torder.php?ID=<?php echo $ID;?>,edit_main,_}	    	  
      {Lesson Linkage,edit_lesson_link.php?ID=<?php echo $ID;?>,edit_main,_}	
      ">
</applet>
    </TD>
  </TR>
...
<applet Code="apPopupMenu" Archive="apPopupMenu.jar" Width = 200" Height = "22" MAYSCRIPT>   
		...
		<param name="menuItems" value="
		  {Save Lesson,javascript:1,_self,images/save.gif}    		
		  {Delete Lesson,javascript:2,_self,images/delete.gif} 
		">
