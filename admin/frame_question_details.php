...
<FRAMESET ROWS="0,60,*" COLS="*" FRAMEBORDER="YES" BORDER="0" FRAMESPACING=0">
	...
	<FRAME NAME="edit_top" SCROLLING="NO" SRC="question_details_top.php?ID=<? echo  $ID ?>&test_name=<? echo  $psname ?>&sel_item=<? echo  $sel_item ?>" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
	<FRAME NAME="edit_main" noresize SRC="<? echo  $pagesource ?>" FRAMEBORDER="NO" BORDER="0" BORDERCOLOR="0" FRAMESPACING="0">
</FRAMESET>	
