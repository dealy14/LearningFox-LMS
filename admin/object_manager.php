...
function orderObjects(obj,cidnameval)
{
	...
	document.location.href="object_manager.php?sid=<?php echo $sid ?>&obtable=<?php echo $obtable; ?>&order="+obj+"&cidval="+cidnameval;
...
{ 
	...
	if($obtable=="course")
	{
	  $course_link = "top.object_manager.object_tree.location='object_tree.php?sid=$sid&cid=$ID';";
