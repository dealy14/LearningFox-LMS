...
<FRAMESET ROWS="0,60,*" COLS="*" FRAMEBORDER="YES" BORDER="0" FRAMESPACING=0">
	...
	<FRAME NAME="edit_top" SCROLLING="NO" SRC="edit_<?= $obtable ?>_top.php?ID=<?= $ID.$topic_extra ?>&selectedTab=<?= $selectedTab ?>" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
	<FRAME NAME="edit_main" noresize SRC="<?= $loadFrame.$topic_extra ?>" FRAMEBORDER="NO" BORDER="0" BORDERCOLOR="0" FRAMESPACING="0">
</FRAMESET>	
