...
{
top.top1.groupOrder=the_order;
document.location.href="group_list.php?order="+the_order;
}
...
//set the new row to the highlight color;
    ...
    top.top1.currGroup=sRow;
}

function openDetails(rID,rname)
{
//top.rmain.details.location="frame_group_details.php?ID="+rID+"&psname="+escape(rname);
top.rmain.details.location="frame_group_details.php?ID="+rID+"&psname="+escape(rname)+"&sel_item=3";
}
</SCRIPT>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
  <TR>
    <TD bgcolor="#EFF7FF" COLSPAN="4"><IMG SRC="images/spcr.gif" HEIGHT="1" WIDTH="370"></TD>
  </TR>
  <TR><TD BGCOLOR="#93BEE2">
<TABLE BORDER="0" CELLPADDING="2" CELLSPACING="0" WIDTH="100%">
  <TR>
    <TD bgcolor="#93BEE2" COLSPAN="4"><IMG SRC="images/spcr.gif" HEIGHT="1" WIDTH="370"></TD>
  </TR>
  <TR>
    <TD bgcolor="#93BEE2" NOWRAP><B><SPAN CLASS="innerl">Name</TD>
    <TD bgcolor="#93BEE2" NOWRAP><B><SPAN CLASS="innerl">Short Name</TD>
...
$db = new db;
$db->connect();
$db->query("SELECT * FROM groups ORDER BY $order");
$xm=0;
while($db->getRows())
{ 
$ID=$db->row("ID");
$rimage="images/groups.gif";  
?>
  <TR CLASS="bkg" ID="m<?php echo $ID;?>">
    ...
    <TD><SPAN CLASS="innerl" NOWRAP><?php echo $db->row("sname");?></TD>
...
if(top.top1.currGroup>=1)
{
eval("document.all.m"+top.top1.currGroup+".style.background=\"#cccccc\"");
}
