...
<FRAMESET ROWS="20%,80%" COLS="*" FRAMEBORDER="YES" BORDER="1" FRAMESPACING="0">
	<FRAME NAME="les_top" SCROLLING="NO" SRC="lessons_top.php" FRAMEBORDER="yes" BORDER="1" FRAMESPACING="0">
	<frameset cols="35%,65%" COLS="2" frameborder="yes" border="1" framespacing="0" style="border:1px solid #000099;">
	<FRAME NAME="les_main" SRC="lessons_manager.php" FRAMEBORDER="yes" BORDER="1" BORDERCOLOR="#336699" FRAMESPACING="0">
