...
{ 
  ...
  this.iconSrcClosed = "images/ftv2folderclosed.gif"   
...
{ 
  ...
  if (level>0) 
    ...
    { 
	  nodeIconName = "images/ftv2mlastnode.gif"
	  if (this.nChildren == 0)
		 nodeIconName = "images/ftv2lastnode.gif"
      ...
      leftSide = leftSide + "<td valign=top><img src='images/ftv2blank.gif' width=16 height=22></td>"  
      this.isLastNode = 1 
    } 
    else 
    { 
	  nodeIconName = "images/ftv2mnode.gif"
	  if (this.nChildren == 0)
		nodeIconName = "images/ftv2node.gif"
      this.renderOb(leftSide + "<td valign=top background=images/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeIconName + "' width=16 height=22 border=0></a></td>") 
      leftSide = leftSide + "<td valign=top background=images/ftv2vertline.gif><img src='images/ftv2vertline.gif' width=16 height=22></td>" 
      this.isLastNode = 0 
    } 
  else 
    this.renderOb("") 
...
{ 
  ...
  {
	  doc.write("<img src=images/ftv2blank.gif height=2 width=2>")
  }
  if (WRAPTEXT)
...
{ 
  ...
  { 
	if (USEFRAMES)
	  doc.write("<a href='" + this.hreference + "' TARGET=\"properties\" ") 
	else
...
{  
  ...
  if (level>0) 
    ...
    { 
      this.renderOb(leftSide + "<td valign=top><img src='images/ftv2lastnode.gif' width=16 height=22></td>") 
      leftSide = leftSide + "<td valign=top><img src='images/ftv2blank.gif' width=16 height=22>"  
    } 
    else 
    { 
      this.renderOb(leftSide + "<td valign=top background=images/ftv2vertline.gif><img src='images/ftv2node.gif' width=16 height=22></td>") 
      leftSide = leftSide + "<td valign=top background=images/ftv2vertline.gif><img src='images/ftv2vertline.gif' width=16 height=22></td>" 
    } 
  else 
    this.renderOb("")   
...
{ 
  ...
  {
	  doc.write("<img src=images/ftv2blank.gif height=2 width=3>")
  }
  if (WRAPTEXT)
    doc.write("</td><td valign=middle width=100%>") 
  else
...
{ 
  ...
  if (USEFRAMES)
  {
	  if (target==0) 
	  { 
		fullLink = "'"+linkData+"' target=\"properties\"" 
	  } 
	  else 
	  { 
		if (target==1) 
		   ...
		   if (target==2)
			  fullLink = "'http://"+linkData+"' target=\"properties\"" 
		   else
...
var auxImg
auxImg = new Image();
auxImg.src = "images/ftv2vertline.gif";
auxImg.src = "images/ftv2mlastnode.gif";
auxImg.src = "images/ftv2mnode.gif";
auxImg.src = "images/ftv2plastnode.gif";
auxImg.src = "images/ftv2pnode.gif";
auxImg.src = "images/ftv2blank.gif";
auxImg.src = "images/ftv2lastnode.gif";
auxImg.src = "images/ftv2node.gif";
auxImg.src = "images/ftv2folderclosed.gif";
auxImg.src = "images/ftv2folderopen.gif";
auxImg.src = "images/ftv2doc.gif";
