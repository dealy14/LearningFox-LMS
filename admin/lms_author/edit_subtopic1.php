...
//get the data values;
$result=MetabaseQuery($database,"SELECT lessons_topics.order_num,lessons.title as lesson_title,topics.title,topics.created,topics.modified,topics.description,topics.time_limit,topics.time_req,topics.launch_str FROM topics,lessons_topics,lessons WHERE topics.topic_id=$ID AND lessons_topics.topic_id=$ID AND lessons.lesson_id=lessons_topics.lesson_id");
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" HEIGHT="100%" ALIGN="CENTER">
	...
	<TR>
		...
		<?php $tsection=1;require("topic_toolbar2.inc");?>
		</TD>	
	</TR>		
	<TR>
		<TD COLSPAN="2" HEIGHT="1" BGCOLOR="#FFFFFF"></TD>	
	...
	<TR BGCOLOR="#dddddd">		
		...
		<TD><INPUT TYPE="TEXT" NAME="title" MAXLENGTH="200" SIZE="60" CLASS="input" VALUE="<?php $title;?>" onKeyup="top.course_tree.subtopic_<?php echo $lesson_id;?>_<?php echo $ID;?>.innerText=this.value"></TD>
	</TR>
	<TR BGCOLOR="#dddddd">		
...
<?php
echo"<SCRIPT>top.lesson_name='$lesson_title';top.document.properties_frame.properties_header.addHistory('edit_subtopic1.php?ID=$ID&course_id=$course_id&lesson_id=$lesson_id','$title ['+document.theform.section.value+']','subtopic');top.course_id=$course_id;</SCRIPT>";
?>
</body>
</html>
