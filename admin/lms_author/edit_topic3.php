...
//get the data values;
$result=MetabaseQuery($database,"SELECT topics.title,topics.code,topics.created,topics.modified FROM topics WHERE topics.topic_id=$ID");
...
$code=MetabaseFetchResult($database,$result,$row,"code");
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" HEIGHT="100%" ALIGN="CENTER">
	...
	<TR>
		...
		<?php $tsection=3;require("topic_toolbar1.inc");?>
		</TD>	
	</TR>		
	<TR>
		<TD COLSPAN="2" HEIGHT="1" BGCOLOR="#FFFFFF"></TD>	
	...
	<TR BGCOLOR="#dddddd">		
		<TD COLSPAN="2"><TEXTAREA NAME="code" STYLE="width:497;height:309" CLASS="input"><?php echo $code;?></TEXTAREA></TD>	
	</TR>			
...
<?php
echo"<SCRIPT>top.document.properties_frame.properties_header.addHistory('edit_topic3.php?ID=$ID&course_id=$course_id','$title ['+document.theform.section.value+']','topic');top.course_id=$course_id;</SCRIPT>";
?>
</body>
</html>
