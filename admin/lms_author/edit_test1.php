...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" HEIGHT="100%" ALIGN="CENTER">
	...
	<TR BGCOLOR="#dddddd">		
		...
		<TD><INPUT TYPE="TEXT" NAME="title" MAXLENGTH="200" SIZE="60" CLASS="input" VALUE="<?php echo $title;?>" onKeyup="top.course_tree.test_<?php echo $ID;?>.innerText=this.value"></TD>
	</TR>
	<TR BGCOLOR="#dddddd">		
...
<?php
echo"<SCRIPT>top.document.properties_frame.properties_header.addHistory('edit_test1.php?ID=$ID&course_id=$course_id','$title ['+document.theform.section.value+']','test');top.course_id=$course_id;</SCRIPT>";
?>
