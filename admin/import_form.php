...
global $courseid,$z,$manifest_path,$scormversion,$uploadpath;
...
//$z=0;
    foreach($xmlObj->children() as $child) {
		...
		$metapath="$uploadpath/".$courseid."/".$pre->location;
