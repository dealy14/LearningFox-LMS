...
<FRAME NAME="formpost" SCROLLING="NO" noresize SRC="edit_lesson_tadd.php?frame=top&lesson_ID=<?php echo $lesson_ID;?>&lname=<?php echo $lname;?>" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="data" SCROLLING="NO" noresize SRC="edit_lesson_tadd.php?frame=middle" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="lists" noresize SRC="edit_lesson_tadd.php?frame=bottom" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="subm" SCROLLING="NO" noresize  SCROLLING="NO" SRC="edit_lesson_tadd.php?frame=bottom2" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<frame src="UntitledFrame-20"></FRAMESET>
...
<FORM NAME="myform" METHOD="POST" ACTION="update_objects_sql.php?action=lesson2&formAction=UPDATE" TARGET="_top">
...
<body bgcolor="#336699" TOPMARGIN="0" RIGHTMARGIN="0" LEFTMARGIN="0">
<IMG SRC="images/lesson_sm.gif" ALIGN="absmiddle"> <SPAN CLASS=hdr>Import Topics Into Lesson:</SPAN>
</body>
...
?>
  <TR>
    <TD BGCOLOR="#FFFFFF"><A HREF="#" onClick="imgOn(<?php echo$ID;?>,'topic_<?php echo$ID;?>');setText('topic_<?php echo$ID;?>_text');return false;"><IMG SRC="images/topic_list_off.gif" NAME="topic_<?php echo$ID;?>" BORDER="0" ALIGN="absmiddle"></A> <INPUT TYPE="TEXT" ID=p<?php echo $ID;?> NAME="topic_<?php echo $ID;?>_text" VALUE="<?php echo $db->row("name");?>" onBlur="setText('topic_<?php echo$ID;?>_text');" CLASS="input2"></TD>
