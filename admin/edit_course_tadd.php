...
<FRAME NAME="formpost" SCROLLING="NO" noresize SRC="edit_course_tadd.php?frame=top&course_ID=<?php echo $course_ID;?>&lname=<?php echo $lname;?>" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="data" SCROLLING="NO" noresize SRC="edit_course_tadd.php?frame=middle" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="lists" noresize SRC="edit_course_tadd.php?frame=bottom" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
<FRAME NAME="subm" SCROLLING="NO" noresize  SCROLLING="NO" SRC="edit_course_tadd.php?frame=bottom2" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
...
<FORM NAME="myform" METHOD="POST" ACTION="update_objects_sql.php?action=course2&formAction=UPDATE" TARGET="_top">
...
$db = new db;
$db->connect();
$db->query("SELECT name,ID,created,modified FROM lesson");
$xm=0;
while($db->getRows())
{ 
$ID=$db->row("ID");
...
<body bgcolor="#336699" TOPMARGIN="0" RIGHTMARGIN="0" LEFTMARGIN="0">
<IMG SRC="images/course2.gif" ALIGN="absmiddle"> <SPAN CLASS=hdr>Import Lessons Into Course:</SPAN>
</body>
...
function imgOn(theimg,imgName)
{
  ...
  {
  eval("document."+imgName+".src=\"images/lesson_list_on.gif\";");
  ...
  {
  eval("document."+imgName+".src=\"images/lesson_list_off.gif\";");
...
<FORM NAME="topics">
  <TR>
    <TD COLSPAN="3"><SPAN CLASS="listtext">Import Lessons into the Course:<BR><IMG SRC="images/spcr.gif" WIDTH="333" HEIGHT="1"><HR COLOR="#336699"></TD>
  </TR>
  <TR>
...
?>
  <TR>
    <TD BGCOLOR="#FFFFFF"><A HREF="#" onClick="imgOn(<?php echo$ID;?>,'topic_<?php echo$ID;?>');setText('topic_<?php echo$ID;?>_text');return false;"><IMG SRC="images/lesson_list_off.gif" NAME="topic_<?php echo$ID;?>" BORDER="0" ALIGN="absmiddle"></A> <INPUT TYPE="TEXT" ID=p<?php echo$ID;?> NAME="topic_<?php echo$ID;?>_text" VALUE="<?php echo$db->row("name");?>" onBlur="setText('topic_<?php echo$ID;?>_text');" CLASS="input2"></TD>
    <TD BGCOLOR="#FFFFFF"><SPAN CLASS="listtext"><?php echo$db->row("created");?></TD>
