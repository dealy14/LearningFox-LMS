...
<STYLE TYPE="text/css">
.input {FONT-FAMILY:VERDANA;FONT-SIZE:10;BORDER-TOP:#EFF7FF 1px solid;BORDER-RIGHT:#EFF7FF 1px solid;BORDER-LEFT:#EFF7FF 1px solid;BORDER-BOTTOM:#EFF7FF 1px solid;BACKGROUND:#EFF7FF}
...
<applet Code="apPopupMenu" Archive="apPopupMenu.jar" Width = 120" Height = "70" MAYSCRIPT>   
		...
		<param name="font" value="VERDANA,10,1">
		<param name="menuItems" value="
		  {_,javascript:1,_self,images/publish2.gif}    		
		">
		<param name="javascript:1" value="rupdate();">
		</applet>
