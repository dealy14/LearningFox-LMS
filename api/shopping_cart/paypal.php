...
/* echo "<script>alert(".$_POST['courseid'].")</script>"; */
...
//test url for ipn -> http://abaceu.com/shopping_cart/paypal.php?action=ipn
// Setup class
...
$email = "dealy@davidealytechnologies.com";

//$email = "gurunathan.sivaraman@gmail.com"; //for testing in sandbox  paypal
...
switch ($_GET['action']) {
    ...
    case 'success':      // Order was successful...
        //update_LMS( $p->ipn_data ,$dir_usercourselist, $cid);
    ...
    case 'ipn':          // Paypal is calling page for IPN validation...
        ...
        if ($p->validate_ipn()) {
            ...
            $body1 = "Thank you very much for your course purchase! You will get the login information shortly. Sometimes It can take several hours depending on the processing speed of the Paypal server \n\n";
            $body1 .= "THIS IS AN AUTOMATED MESSAGE FROM LEARNINGFOX.COM\n\n";
            $body1 .= "\n" . date('m/d/Y');
            $headers1 = "From: test@test.com" . "\r\n";
...
/*
  ...
  CREATE TABLE `paypal_order_info`
  ...
  `datecreation` date NOT NULL default '0000-00-00' ) TYPE=MyISAM;
 */
?>