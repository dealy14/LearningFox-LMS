...
<?php
	...
	{?>
  <tr bgcolor="#FFFFFF">
    <td colspan="2"  style="background-image:url('site_conf/images/det_banner_in.jpg'); background-repeat:no-repeat; background-position:center;" width="1000" height="100" align="right">
	<?php
	}
	else
	{ ?>
	<tr bgcolor="#1E1E1F">
    <td colspan="2"  style="background-image:url('site_conf/images/det_banner.jpg'); background-repeat:no-repeat; background-position:center;" width="800" height="100" align="right">
	<?php }?>
	<?php
	if(!is_null($sid)&&$session_error=="none")
	{
	...
	<TR>
		<TD><FONT FACE="VERDANA" SIZE="1" COLOR="#FFFFFF">Logged in as: <B><?php echo $lms_username; ?></B></TD>
	</TR>
		<?php
