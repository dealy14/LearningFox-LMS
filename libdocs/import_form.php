...
//echo "Type: " . $_FILES["file"]["type"] . "hello<br />";
				if ($_FILES["file"]["type"]=="application/zip" || $_FILES["file"]["type"]=="application/x-zip-compressed"){
							 if ($_FILES["file"]["error"] > 0) {
									...
									/*if(!file_exists("uploadfiles/".$_POST['cn']))
									 ...
									 if (file_exists("../uploadfiles/". basename($_FILES["file"]["name"],".zip"))){
													...
													echo '<script>alert("'.$file420.'")</script>';
												...
												fwrite($fopen, zip_entry_read($zip_entry, zip_entry_filesize($zip_entry)), zip_entry_filesize($zip_entry));
													 ...
													 if(!file_exists($file1))
															mkdir($file1,0777);
															//chdir($file1);
															echo '<script>alert("'.$file1.'")</script>';
													...
													echo '<script>alert("'.$dir_name.'")</script>';
					...
					/*...code to read title tag in imsmanifest.xml file....*/
												 ...
												 //$path=$_SERVER['DOCUMENT_ROOT']."/v1/admin/uploadfiles/".basename($file,".zip")."/sco/imsmanifest.xml";
												 							// $path1=$manifest_path;
