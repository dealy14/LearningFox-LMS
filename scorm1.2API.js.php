...
$db = new db;
$db->connect();
$user_sco = "SELECT * FROM user_sco_info WHERE user_id=" . $_SESSION['student_id'] .
                                    " AND course_id='" . $_SESSION['course_identifier'] . "'" .
                                    " AND user_id=" . $_SESSION['student_id'] .
                                    " AND lesson_status NOT LIKE ('%completed%') " .
                                    " AND (sco_entry='ab-initio' OR sco_entry='resume') " .
                                    " ORDER BY sequence ";
$db->connect();
$db->query($user_sco);
$masterscory = 'y';
...
//			var data="lesson_status=incomplete&sco_id="+str_scoid+
//                      "&sco_entry="+sco_entry+"&sco_exit="+sco_exit+"&total_time="+
//                      cmi_total_time+"&score="+raw_score+"&lesson_location="+lesson_location+"&
//                      suspend_data="+cmi_suspend_data+"&session_time="+session_time;
...
function LMSSetValue(param1,param2){
    ...
    if (initialize == true) {
        ...
        if (param1 == "cmi.core._children") {
            ...
            if (isNaN(param2)) {
                if (param2 == "passed" || param2 == "completed"
                        || param2 == "failed" || param2 == "incomplete"
                        || param2 == "browsed" || param2 == "incomplete") {
            ...
            if (param2 == "logout" || param2 == "time-out" ||
                        param2 == "suspend" || param2 == "") {
                errorCode = "0";
                sco_exit = param2;
                return "true";
            }
            ...
            if (param1 == "cmi.interactions." + n + ".type") {
                if (param2 == "true-false" || param2 == "choice" || param2 == "fill-in"
                        || param2 == "matching" || param2 == "performance" || param2 == "sequencing"
                        || param2 == "likert" || param2 == "numeric") {
            ...
            if (param1 == "cmi.interactions." + n + ".result") {
                if (param2 == 'correct' || param2 == 'wrong' || param2 == 'unanticipated'
                        || (!isNaN(param2)) || param2 == 'neutral') {
...
} // end function LMSGetErrorString()
...
function LMSFinish(param) {
    if(initialize == true) {
        if(param == "") {
            ...
            errorCode = "0";
            if(lesson_status == "incomplete" || sco_exit == "logout"
                    || sco_exit == "suspend"){
            ...
            var data="lesson_status="+lesson_status+"&sco_id="+str_scoid+
                    "&sco_entry="+sco_entry+"&sco_exit="+sco_exit+
                    "&total_time="+cmi_total_time+"&score="+raw_score+
                    "&lesson_location="+lesson_location+"&suspend_data="+
            cmi_suspend_data+"&session_time="+session_time;
            ...
            if(lesson_status == "completed" || lesson_status == "failed"
