...
$extr="ORDER BY $order $direction";
	...
	<TR>
	  ...
	  <TD BGCOLOR="#FFFFFF" VALIGN=TOP><FONT FACE="VERDANA" SIZE="1"><?php echo $cstatus;?></TD>
	  ...
	  <TD BGCOLOR="#FFFFFF" VALIGN=TOP><FONT FACE="VERDANA" SIZE="1"><?php echo date("H:i:s", mktime (0,0,$db->row("total_time")));?></TD>
