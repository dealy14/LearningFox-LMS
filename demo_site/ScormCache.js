...
/*function ArrayCopy(List, ListToCopyFrom, StartAt, Length)
	Dim i
	ReDim List(Length - 1)
	For i = 0 To Length - 1
		List(i) = ListToCopyFrom(i + StartAt)
	Next
End Sub*/
...
ScormParamInfo.prototype.Initialize = function( param, dom, method, value ) {
	this.m_dom = dom;
...
ScormParamInfo.prototype.isWriteable = function() { 
