...
<script language="javascript" src="SCORM_API_wrapper.js"></script>
...
<form name="buttonform">
 <object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0" id="APIAdapter" codebase="http://java.sun.com/products/plugin/1.3/jinstall-13-win32.cab#Version=1,3,0,0">
    ...
    <comment>
    <applet code="org/adl/samplerte/client/APIAdapterApplet.class" archive="cmidatamodel.jar,lmsclient.jar,debug.jar"  height="1" id="APIAdapter"  name="APIAdapter"   width="1"  mayscript="true">
    </applet>
    </comment>
    </object>         
    <table width="800">
    <tr valign="top"> 
       ...
       <td align="center"><strong><font color="purple" size="2" face="Tahoma">LearningFox content packages Launching window </font></strong></td>
    </tr>
    </table> 
