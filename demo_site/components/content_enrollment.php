...
<?php
  ...
  ?>
   ...
   <TABLE BORDER="0" CELLSPACING="1" CELLPADDING="4">
    <TR BGCOLOR="#000000">
	   <TD><FONT FACE="VERDANA" SIZE="2" COLOR="#FFFFFF">&nbsp;</TD>		
       <TD NOWRAP><FONT FACE="VERDANA" SIZE="2" COLOR="#FFFFFF">Survey Title</TD>  
	   <TD NOWRAP><FONT FACE="VERDANA" SIZE="2" COLOR="#FFFFFF">Survey Type</TD>
	   <TD><FONT FACE="VERDANA" SIZE="2" COLOR="#FFFFFF">&nbsp;</TD>	   
     </TR>
  <?php
  while($dbsurvey->getRows())
  {
	...
	?>
	     <TR BGCOLOR="<?php echo $bgcol; ?>">
       <TD VALIGN="TOP"><A HREF="#"><FONT FACE="VERDANA" SIZE="2"><IMG SRC="images/course_list2.gif" BORDER="0" ALT="Click for more details on <?php echo $dbsurvey->row("name");?>"></A></TD>
       <TD VALIGN="TOP"><A HREF="#" STYLE="text-decoration:none;color:#000000;"><FONT FACE="VERDANA" SIZE="2"><B><?php echo $dbsurvey->row("name");?></TD>	   
       <TD VALIGN="TOP"><FONT FACE="VERDANA" SIZE="2"><?php echo $dbsurvey->row("type");?></FONT></TD>
       <TD VALIGN="TOP"><A HREF="#"><FONT FACE="VERDANA" SIZE="2">[<A target="_blank" HREF= "../surveys/survey.php?sid=<?php echo $sid; ?>&survey_ID=<?php echo $dbsurvey->row("survey");?>">Launch</A>]</TD>
     </TR>
	<?php
  }
?>