...
<?php if(!is_null($cID[$mycourses[$x]])&&$course_status[$mycourses[$x]]!="Complete"){ ?>
     <TR BGCOLOR="<?php echo $bgcol;?>">
       ...
       <TD VALIGN="TOP"><A HREF="#" STYLE="text-decoration:none;color:#000000;"><FONT FACE="VERDANA" SIZE="2"><B><?php $cname[$mycourses[$x]]; ?></TD>	   
       ...
       <TD VALIGN="TOP"><A HREF="#"><FONT FACE="VERDANA" SIZE="2">[<A HREF="index.php?section=courselaunch&sid=<?php ech $sid; ?>&course_ID=<?php echo $cID[$mycourses[$x]]; ?>">Details</A>]</TD>
     </TR>
<?php }?>
...
<?php if(!is_null($cID[$mygcourses[$xn]])&&$course_status[$mygcourses[$xn]]!="Complete"){?>
     <TR BGCOLOR="<?php echo $bgcol; ?>">
       ...
       <TD VALIGN="TOP"><A HREF="#" STYLE="text-decoration:none;color:#000000;"><FONT FACE="VERDANA" SIZE="2"><B><?php $cname[$mygcourses[$xn]]; ?></TD>	   
