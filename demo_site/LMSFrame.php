...
$qryScoNm = "select * from user_sco_info where course_id = '".$rowCrseNm->course_id."' and user_id=".$_SESSION['student_id']." and lesson_status not like('%completed%') and (sco_entry='ab-initio' or sco_entry='resume') order by sequence";
//die($qryScoNm);
...
<form name="buttonform">
    ...
    <tr valign="top"> 
       ...
       <td><strong><font color="black" size="3" face="Tahoma"><div style="margin-left:280px">Learning Content Packages launching window</div></font></strong></td>
    </tr>
    </table> 
    ...
    <tr>-->
       <td> 
        <!--  <input type="button" value="Log In" id="login" name="login" language="javascript"
                 onclick="return login_onclick();">&nbsp;    -->          </td>
       <td align="left">
          <input type="button" value="Log Out" id="logout" name="logout" 
                 language="javascript" onClick="return logout_onclick();"  style="visibility:hidden" >       </td>
       <TD ALIGN="center">
             <INPUT type="button" ALIGN = "right" VALUE="    Quit    " name="quit" language="javascript"
                ONCLICK="doConfirm();"  style="visibility:hidden" >       </TD>
       <td align="left">
          <input type="button" align ="left" value="Suspend" id="suspend" name="suspend"  language="javascript"
                 onclick="return suspendtest();"  style="visibility:hidden" >&nbsp;       </td>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
       <td align="center"> 
          <?php
		  	if($totalCnt > 1){
