            ...
            <td class="navbar">
             ...
             <table class="topnav" align="right" border="0" cellpadding="5">
                 ...
                 <tbody>
                     ...
                     <tr>
<?php
if($_REQUEST['section']!='login' && $_REQUEST['section']!='' && $_REQUEST['logout']!='YES')
{
                         ...
                         <td class="topnav-link"><a href="contact.html">Contact Us</a></td>
                          ...
                          <td class="topnav-link" id="loginState"><a href="index.php?section=login&sid=<?php echo $sid; ?>">Login</a></td>
							<?php } else { ?>
							  ...
							  <td class="topnav-link" id="loginState"><a style="" href="index.php?section=<?php echo $section; ?>&logout=YES&sid=<?php echo $sid; ?>">
