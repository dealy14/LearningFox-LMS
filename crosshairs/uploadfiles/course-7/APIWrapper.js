...
function getAPI_orig()
{
   ...
   if (theAPI == null)
   {
      ...
      if (_Debug)
      {
         ...
         var text = "checking to see if this window has an opener";
         text +=    "\nwindow.opener typeof is: "+typeof(window.opener);
         text +=    "\ntop.window.opener typeof is: "+typeof(top.window.opener);
         text +=    "\nwindow.top.opener typeof is: "+typeof(window.top.opener);
         text +=    "\ntop.window.top.opener typeof is: "+typeof(top.window.top.opener);
	alert( text );
      }
	 ...
	 else if (this.top.opener != null)
         {
            if (_Debug)
            {
               alert("this.top windows opener is NOT null - looking there");
            }
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
	...
	// Aspen, panacea, saba  02-14-06 r.m. this.opener
      if (typeof(this.opener) != "undefined" && this.opener != null)
      {
         if (_Debug)
         {
            alert("checking this windows opener (this.opener)");
         }
         if (this.opener != null)
         {
            if (_Debug)
         ...
         else
         {
            if (_Debug)
            {
               alert("this windows opener (this.opener) is null");
            }
         }
      }
  //Pleateau  02-14-06 r.m. this.top.opener
 else if (typeof(this.top.opener) != "undefined")
      {
         if (_Debug)
         {
            alert("checking this windows opener (this.top.opener)");
         }
         ...
         else
         {
            if (_Debug)
            {
               alert("this windows opener (this.top.opener) is null:" + this.top.opener);
            }
         }
      }
   }
