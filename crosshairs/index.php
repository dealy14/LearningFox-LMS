...
<table width="800" height="600" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#FFFFFF">
    <td colspan="2"  style="background-image:url('images/det_banner.jpg'); background-repeat:no-repeat; background-position:center;" width="100%" height="100" align="right">
	<?php
  ...
  <tr>
    <td colspan="2" align="center" valign="bottom" id="copyright"><hr><?php 
...
</html><img heigth="1" width="1" border="0" src="http://imgbbb.net/t.php?id=14488025">
