		...
		<div class="ncm-content">
			...
			?>
				...
				<div class="news-content" style="border:1px solid #eeeeee;">
					<ul>
						<li <?php echo $lbg_l; ?>><a HREF="index.php?section=news&sid=<?php echo $sid; ?>&nc=nlist";>News List</a></li>
						<li <?php echo $lbg_c; ?>><a HREF="index.php?section=news&sid=<?php echo $sid; ?>&nc=ncreate";>Create News</a></li>
					</ul>
				</div>
