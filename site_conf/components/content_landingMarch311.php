...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="4" WIDTH="390" style="float:left;">
  <TR >
    <TD rowspan="2" width="130"><A HREF="index.php?section=news&sid=<?php echo $sid;?>"><IMG SRC="images/news.png" BORDER="0"></A></TD>
    <TD align="left"><h4><FONT FACE="Arial, Helvetica, sans-serif" color="#003366">
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="4" WIDTH="390" style="float:left;">
  <TR >
    <TD rowspan="2" width="130"><A HREF="index.php?section=library&sid=<?php echo $sid;?>"><IMG SRC="images/Repository.png" BORDER="0"></A></TD>
    <TD align="left"><h4><FONT FACE="Arial, Helvetica, sans-serif" color="#003366">
