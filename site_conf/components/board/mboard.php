...
mysql_select_db("lmscecdb") or die(mysql_error());
...
<div id="container2" style="width:800px; text-align:center;">

	<div id="main" style="width:800px; text-align:center;">
		...
		<div id="main-content" style="width:800px; text-align:center;">
			<?php //include 'includes/left-nav.php'; ?>
			
			<div id="main-content-b" style="width:790px;">
...
if(strlen($to)>0)
{
	...
	$subject = $name.' responsed "'.$subject.'"';
	$body = "<div>Date: ".date("l, F d, Y")."</div><div>".$name." responsed a message</div><div>To access the site, <a href='http://www.davidealytechnologies.com/anlm/' target'_blank'>click here</a></div>";
...
<!--[if IE 5]><style type="text/css">@import "'.$settings['mboard_url2'].'site_conf/components/board/styleIE.css";</style><![endif]-->
<!--[if IE 6]><style type="text/css">@import "'.$settings['mboard_url2'].'site_conf/components/board/styleIE.css";</style><![endif]-->
<!--[if IE 7]><style type="text/css">@import "'.$settings['mboard_url2'].'site_conf/components/board/styleIE.css";</style><![endif]-->
...
{
	$to = substr($to,0,strlen($to)-2);
	$subject = $name.' added a message "'.$subject.'"';
	$body = "<div>Date: ".date("l, F d, Y")."</div><div>".$name." added a message</div><div>To access the site, <a href='http://www.davidealytechnologies.com/anlm/' target'_blank'>click here</a></div>";
	$headers  = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
	$headers .= 'From: LearningFox Support <dealy@davidealytechnologies.com>' . "\r\n";
	//die($to."<br/>".$subject."<br/>".$body);
