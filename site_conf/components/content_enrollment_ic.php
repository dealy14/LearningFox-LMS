...
<?php if(!is_null($cID[$mycourses[$x]])&&$course_status[$mycourses[$x]]!="passed"&&$course_status[$mycourses[$x]]!="completed"&&$course_status[$mycourses[$x]]!="failed"){ ?>
     <TR BGCOLOR="<?php echo $bgcol;?>">
	   ...
	   <TD VALIGN="TOP"><FONT FACE="VERDANA" SIZE="2"><?php if($course_status[$mycourses[$x]]!="Complete"){echo"<FONT COLOR='RED'>";}echo $course_status[$mycourses[$x]];?></FONT></TD>
...
?>
     <TR>
       <TD COLSPAN="6" BGCOLOR="#FFFFFF"><FONT FACE="VERDANA" SIZE="2"><BR><BR>The courses below were added to your list by your administrator.</TD>
     </TR>
<?php
     $xn=0;
...
<?php if(!is_null($cID[$mygcourses[$xn]])&&$course_status[$mycourses[$x]]!="passed"&&$course_status[$mycourses[$x]]!="completed"&&$course_status[$mycourses[$x]]!="failed"){?>
     <TR BGCOLOR="<?php echo $bgcol;?>">
       ...
       <TD VALIGN="TOP"><A HREF="#" STYLE="text-decoration:none;color:#000000;"><FONT FACE="VERDANA" SIZE="2"><B><?php echo $cname[$mygcourses[$xn]];?></B></FONT></TD>	   
