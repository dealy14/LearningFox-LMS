...
<BODY BGCOLOR="#FFFFFF">
<DIV ID="tester" CLASS="rd" NAME="dd" STYLE="position:absolute; left:0px; top:244px; width:369px; height:201px; z-index:1; background-color: #CCCCCC; layer-background-color: #CCCCCC; border: 1px none #000000;"><A HREF="#" onMouseDown="MM_dragLayer('tester','',0,0,0,0,true,false,-1,-1,-1,-1,false,false,0,'',false,'')">DRAG</A><IFRAME SRC="object_manager.php?obtable=topic" WIDTH="369"></IFRAME></DIV>

<A HREF="#" onClick='document.all.tester.style.visibility="hidden"'>test here </A>
</BODY>
</HTML>
