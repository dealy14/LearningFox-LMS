...
<frameset rows="20%,80%" ROWS="2" frameborder="yes" border="1" framespacing="0" > 
	...
	<FRAME NAME="les_tree" SCROLLING="no" SRC="content_courselaunch1.php?ref=<?php echo $_GET['ref'];?>&sid=<?php echo $sid ?>" FRAMEBORDER="no" BORDER="1" BORDERCOLOR="#336699" FRAMESPACING="0"> 
	<FRAME NAME="les_main" FRAMEBORDER="no" BORDER="1" BORDERCOLOR="#336699" FRAMESPACING="0"> 
	</frameset>
</frameset>
