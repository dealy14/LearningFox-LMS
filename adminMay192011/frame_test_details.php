...
if($sel_item==1 && $ID)
{
$pagesource="test_details.php?ID=$ID&test_name=$psname";
}
else if($sel_item==2)
{
...
<FRAMESET ROWS="0,60,*" COLS="*" FRAMEBORDER="YES" BORDER="0" FRAMESPACING=0">
	...
	<FRAME NAME="edit_top" SCROLLING="NO" SRC="test_details_top.php?ID=<?php echo $ID;?>&test_name=<?php echo $psname;?>&sel_item=<?php echo $sel_item;?>" FRAMEBORDER="NO" BORDER="0" FRAMESPACING="0">
