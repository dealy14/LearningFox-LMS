...
<a href="content-preview.php?sid=<?php echo $_GET['sid'] ?>&ref=<?php echo $_REQUEST['ID'];?>" class="thebutton" target="_blank"><!--<img src="images/delete.gif" border="0" alt="Delete course">--> Preview</a></TD>
</TR>
</TABLE>
