...
$db = new db;
$db->connect();
$db->query("SELECT * FROM lesson WHERE ID='$ID'");
$xm=0;
while($db->getRows())
{ 
$rID=$db->row("ID");
...
<FORM NAME="editForm" METHOD="POST" ACTION="update_objects_sql.php?action=lesson1" target="edit_post">
...
<INPUT TYPE="HIDDEN" NAME="formAction">
	...
	<TABLE BORDER="0" CELLSPACING="1" CELLPADDING="4">
	  <TR>
	    <TD><SPAN CLASS=ttl>Lesson Title:</SPAN></TD>
	    <TD><INPUT TYPE="TEXT" NAME="name" CLASS="input" VALUE="<?php echo $name;?>"></TD>		
	  </TR>
	  <TR>
	    <TD VALIGN="TOP"><SPAN CLASS=ttl>Description:</SPAN></TD>
	    <TD><TEXTAREA ROWS=5 COLS=50 CLASS="input">Some Descr.</TEXTAREA></TD>		
	  </TR>   	  	
	  <!--<TR BGCOLOR="#EFF7FF" >
