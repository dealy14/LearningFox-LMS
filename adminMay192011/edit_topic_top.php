...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  <TR>
    <TD ROWSPAN="2" VALIGN="TOP"><IMG SRC="images/edit_topic.gif" ALIGN="absmiddle"> &nbsp;</TD>
...
<param name="menuItems" value="
      {Properties,edit_topic_bottom.php?ID=<?php echo $ID;?>,edit_main,_}
      {Code,edit_topic_code.php?ID=<?php echo $ID;?>&loc=<?php echo $loc;?>&type=<?php echo $type;?>,edit_main,_}
      {Topic Linkage,edit_topic_link.php?ID=<?php echo $ID;?>&loc=<?php echo $loc;?>&type=<?php echo $type;?>,edit_main,_}		    	  
      ">
</applet>
<!--      {Code,edit_topic_code.php?ID=<?php echo $ID;?>&loc=<?php echo $loc;?>&type=<?php echo $type;?>,edit_main,_}-->
...
<applet Code="apPopupMenu" Archive="apPopupMenu.jar" Width = "220" Height = "22" MAYSCRIPT>   
		...
		<param name="menuItems" value="
		  {Save Changes,javascript:1,_self,images/save.gif}    		
		  {Delete Object,javascript:2,_self,images/delete.gif} 
		">
